...
class ConfigurationRoute {
    ...
    create() {
        ...
        this.router.route('/parentKeyWithDetail').get(controller.parentKeyWithDetail);
        this.router.route('/parentKeyToFindTehsil').get(controller.parentKeyToFindTehsil);
        this.router.route('/keyToFindAdmissionTypes').get(controller.keyToFindAdmissionTypes);
    }
}
